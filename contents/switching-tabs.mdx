...
[Tab](https://phuoc.ng/collection/css-layout/tab) is a popular pattern to group content by different titles. When users switch between tabs, we animate the bottom line to indicate the selected tab.
...
<div class="tabs" id="container">
    <div class="tabs__titles">
        ...
        <button class="tabs__title">Week</button>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const indicatorEle = document.getElementById('selectedIndicator');
    ...
    const activateTab = (index) => {
        ...
        const containerPaddingLeft = window.getComputedStyle(containerEle).paddingLeft;
...
-   [Radio switch](https://phuoc.ng/collection/css-animation/radio-switch)
